<template>
    <div>
        <section data-bs-version="5.1" class="slider1 cid-tuzuKFNxWG" id="slider1-3f">
    
    <div class="carousel slide" id="twaOAF13T1" data-interval="5000" data-bs-interval="5000">
        <ol class="carousel-indicators">
            <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#twaOAF13T1" data-bs-target="#twaOAF13T1"></li>
            <li data-slide-to="1" data-bs-slide-to="1" data-target="#twaOAF13T1" data-bs-target="#twaOAF13T1"></li>
            <li data-slide-to="2" data-bs-slide-to="2" data-target="#twaOAF13T1" data-bs-target="#twaOAF13T1"></li>
        </ol>
        ...
        <a class="carousel-control carousel-control-prev" role="button" data-slide="prev" data-bs-slide="prev" href="#twaOAF13T1">
            <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
            <span class="sr-only visually-hidden">Previous</span>
        </a>
        <a class="carousel-control carousel-control-next" role="button" data-slide="next" data-bs-slide="next" href="#twaOAF13T1">
                ...
                <div class="col-12 col-lg">
                    <div class="text-box">
                        ...
                        <div class="mbr-section-btn pt-3">
                            <a href="#" class="btn btn-primary display-4">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section data-bs-version="5.1" class="features7 cid-tuzuUjSCQI" id="features8-3j">
    <!---->
...
<section data-bs-version="5.1" class="features9 popup-btn-cards cid-twaGkP5qCe" id="features9-40">
                ...
                <div class="image-element card-wrapper">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="collapsed-content">
                            ...
                            <div class="mbr-section-btn"><a class="btn btn-md btn-primary display-4" href="#">View All</a></div>
                        </div>
                   </div>
               </div>
            </div>
...
<section data-bs-version="5.1" class="content1 cid-tuzuMKvTcz" id="content1-3g">
...
<section data-bs-version="5.1" class="teams1 cid-twaGraj1h8" id="teams1-41">
    ...
    <div class="container">
        <h2 class="mbr-section-title mbr-fonts-style align-left mbr-black display-2">
            Check out some Creators</h2>
        <h3 class="mbr-section-subtitle mbr-fonts-style align-left pt-2 display-5"><em>Show them support by following them</em></h3>
        <div class="row justify-content-center flip-card pt-4">
            ...
            <div class="col-md-6 col-lg-3 card-wrap">
                ...
                <h5 class="mbr-fonts-style mbr-role align-left pt-2 display-4">Service Advisor</h5>
                <p class="mbr-fonts-style mbr-text align-left pt-1 display-7">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis, pariatur.
                </p>
            </div>
            <div class="col-md-6 col-lg-3 card-wrap">
                ...
                <h5 class="mbr-fonts-style mbr-role align-left pt-2 display-4">Purchasing Officer</h5>
                <p class="mbr-fonts-style mbr-text align-left pt-1 display-7">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis, pariatur.
                </p>
            </div>
            <div class="col-md-6 col-lg-3 card-wrap">
                ...
                <h5 class="mbr-fonts-style mbr-role align-left pt-2 display-4">Business Analyst</h5>
                <p class="mbr-fonts-style mbr-text align-left pt-1 display-7">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis, pariatur.
                </p>
            </div>
