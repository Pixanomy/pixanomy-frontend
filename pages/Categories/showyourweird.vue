<template>
    <div>
        <weirdbar />
        <v-row class="categoryPage" style="background-color: gold;">
            <v-col cols="12">
                <h4 style="color: black !important;">Lastest from the Wall of Weird</h4>
...
<script>
    import weirdbar from '../../components/Menus/weirdbar.vue'
