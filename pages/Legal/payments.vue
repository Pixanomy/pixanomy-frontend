<template>
    <div>
        <section class="content4 cid-so7VtOL9Fi" id="content4-1a">
        ...
        <div class="row justify-content-center">
            <div class="title col-md-12 col-lg-10">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2">
                    <strong>Payments Conditions of Use</strong></h3>
...
<section class="content7 cid-so7Vs056yl" id="content7-19">
...
<script setup>
    useHead({
        title: 'Payments Conditions of Use',
    })
</script>